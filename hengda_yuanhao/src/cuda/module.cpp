...
void SparseMatmul::backward() {
    ...
    b->zero_grad();
    // ** may have conflict in this line! *
    int row = 0;
...
void GraphSum::backward() {
    ...
    // GraphSum_backward(in, out, graph, dim);
    #ifdef __CUDACC__
...
void ReLU::backward() {
    ...
    // ReLU_backward(in, mask, training);
    #ifdef __CUDACC__
